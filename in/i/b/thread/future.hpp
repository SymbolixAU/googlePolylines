...
#include <b/thread/condition_variable.hpp>
#include <b/thread/detail/move.hpp>
#include <b/thread/detail/invoker.hpp>
#include <b/thread/detail/invoke.hpp>
#include <b/thread/detail/is_convertible.hpp>
#include <b/thread/exceptional_ptr.hpp>
#include <b/thread/futures/future_error.hpp>
#include <b/thread/futures/future_error_code.hpp>
#include <b/thread/futures/future_status.hpp>
#include <b/thread/futures/is_future_type.hpp>
#include <b/thread/futures/launch.hpp>
#include <b/thread/futures/wait_for_all.hpp>
#include <b/thread/futures/wait_for_any.hpp>
#include <b/thread/lock_algorithms.hpp>
#include <b/thread/lock_types.hpp>
#include <b/thread/mutex.hpp>
#include <b/thread/thread_only.hpp>
#include <b/thread/thread_time.hpp>
#include <b/thread/executor.hpp>
#include <b/thread/executors/generic_executor_ref.hpp>

#if defined BOOST_THREAD_FUTURE_USES_OPTIONAL
#include <b/optional.hpp>
#else
#include <b/thread/csbl/memory/unique_ptr.hpp>
#endif

#include <b/assert.hpp>
#include <b/bind/bind.hpp>
#ifdef BOOST_THREAD_USES_CHRONO
#include <b/chrono/system_clocks.hpp>
#endif
#include <b/core/enable_if.hpp>
#include <b/core/ref.hpp>
#include <b/enable_shared_from_this.hpp>
#include <b/exception_ptr.hpp>
#include <b/function.hpp>
#include <b/scoped_array.hpp>
#include <b/shared_ptr.hpp>
#include <b/smart_ptr/make_shared.hpp>
...
#include <b/thread/detail/memory.hpp>
#include <b/container/scoped_allocator.hpp>
...
#include <b/thread/csbl/tuple.hpp>
#include <b/thread/csbl/vector.hpp>
#endif
...
#include <b/thread/detail/atomic_undef_macros.hpp>
          if(!atomic_load(&future_))
            {
                future_ptr blank;
                atomic_compare_exchange(&future_,&blank,future_ptr(new detail::shared_state<R>));
            }
#include <b/thread/detail/atomic_redef_macros.hpp>
#endif
        }
