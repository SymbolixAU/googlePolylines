...
#include <b/range/rend.hpp>
#include <b/range/rbegin.hpp>
#include <b/range/iterator.hpp>
#include <b/range/reverse_iterator.hpp>
...
#include <b/foreach_fwd.hpp>

#ifdef BOOST_FOREACH_RUN_TIME_CONST_RVALUE_DETECTION
# include <new>
# include#include <b/aligned_storage.hpp>
# include#include <b/utility/enable_if.hpp>
# include#include <b/type_traits/remove_const.hpp>
#endif
...
struct foreach_iterator
{
    ...
    //
    // To treat the container as an array, use boost::as_array() in#include <b/range/as_array.hpp>,
