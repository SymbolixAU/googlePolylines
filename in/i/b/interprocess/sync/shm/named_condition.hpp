...
#include <b/interprocess/sync/shm/named_creation_functor.hpp>
#include <b/interprocess/sync/named_mutex.hpp>
#include <b/interprocess/permissions.hpp>
   ...
   #include <b/interprocess/sync/detail/condition_any_algorithm.hpp>
#else
   #include <b/interprocess/sync/detail/locks.hpp>
#endif
