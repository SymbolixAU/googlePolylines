...
#include <b/interprocess/sync/posix/named_semaphore.hpp>
//Experimental...
#elif !defined(BOOST_INTERPROCESS_FORCE_GENERIC_EMULATION) && defined (BOOST_INTERPROCESS_WINDOWS)
   #include <b/interprocess/sync/windows/named_semaphore.hpp>
   #define BOOST_INTERPROCESS_NAMED_SEMAPHORE_USE_WINAPI
#else
   #include <b/interprocess/sync/shm/named_semaphore.hpp>
#endif
