...
#include <b/interprocess/containers/map.hpp>
#include <b/interprocess/allocators/private_adaptive_pool.hpp>
#include <b/intrusive/detail/minimal_pair_header.hpp>         //std::pair
