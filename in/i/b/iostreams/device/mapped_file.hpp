...
#include <b/config.hpp>                   // make sure size_t is in std.
#include <cstddef>                            // size_t.
#include <string>                             // pathnames.
#include <utility>                            // pair.
#include <b/config.hpp>                   // BOOST_MSVC.
#include <b/detail/workaround.hpp>
#include <b/iostreams/close.hpp>
#include <b/iostreams/concepts.hpp>
#include <b/iostreams/detail/config/auto_link.hpp>
#include <b/iostreams/detail/config/dyn_link.hpp>
#include <b/iostreams/detail/config/wide_streams.hpp>
#include <b/iostreams/detail/ios.hpp>     // openmode, failure
#include <b/iostreams/detail/path.hpp>
#include <b/iostreams/operations_fwd.hpp>
#include <b/iostreams/positioning.hpp>
...
#include <b/config/abi_suffix.hpp> // pops abi_suffix.hpp pragmas
#if defined(BOOST_MSVC)
