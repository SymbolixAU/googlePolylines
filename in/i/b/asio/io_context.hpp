...
#include <b/asio/detail/chrono.hpp>
#include <b/asio/detail/concurrency_hint.hpp>
#include <b/asio/detail/cstdint.hpp>
#include <b/asio/detail/wrapped_handler.hpp>
#include <b/system/error_code.hpp>
#include <b/asio/execution.hpp>
#include <b/asio/execution_context.hpp>

#if defined(BOOST_ASIO_WINDOWS) || defined(__CYGWIN__)
# include#include <b/asio/detail/winsock_init.hpp>
#elif defined(__sun) || defined(__QNX__) || defined(__hpux) || defined(_AIX) \
  || defined(__osf__)
# include#include <b/asio/detail/signal_init.hpp>
#endif
...
#include <b/asio/impl/io_context.hpp>
#if defined(BOOST_ASIO_HEADER_ONLY)
# include#include <b/asio/impl/io_context.ipp>
...
#  include#include <b/asio/io_context_strand.hpp>
