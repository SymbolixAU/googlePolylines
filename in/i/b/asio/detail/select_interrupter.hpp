...
# include#include <b/asio/detail/socket_select_interrupter.hpp>
#elif defined(BOOST_ASIO_HAS_EVENTFD)
# include#include <b/asio/detail/eventfd_select_interrupter.hpp>
#else
# include#include <b/asio/detail/pipe_select_interrupter.hpp>
#endif
