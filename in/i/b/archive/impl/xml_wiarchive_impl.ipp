...
#include <b/config.hpp> // msvc 6.0 needs this to suppress warnings
#ifndef BOOST_NO_STD_WSTREAMBUF

#include <b/assert.hpp>
#include <algorithm> // std::copy
#include <b/detail/workaround.hpp> // Dinkumware and RogueWave
#if BOOST_WORKAROUND(BOOST_DINKUMWARE_STDLIB, == 1)
#include <b/archive/dinkumware.hpp>
#endif

#include <b/io/ios_state.hpp>
#include <b/core/uncaught_exceptions.hpp>
#include <b/core/no_exceptions_support.hpp>
#include <b/serialization/string.hpp>

#include <b/archive/basic_xml_archive.hpp>
#include <b/archive/xml_wiarchive.hpp>

#include <b/archive/xml_archive_exception.hpp>
#include <b/archive/iterators/mb_from_wchar.hpp>

#include <b/archive/detail/utf8_codecvt_facet.hpp>
