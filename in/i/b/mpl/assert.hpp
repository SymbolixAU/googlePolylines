...
#include <b/mpl/aux_/nested_type_wknd.hpp>
#include <b/mpl/aux_/yes_no.hpp>
#include <b/mpl/aux_/na.hpp>
#include <b/mpl/aux_/adl_barrier.hpp>

#include <b/mpl/aux_/config/nttp.hpp>
#include <b/mpl/aux_/config/dtp.hpp>
#include <b/mpl/aux_/config/gcc.hpp>
#include <b/mpl/aux_/config/msvc.hpp>
#include <b/mpl/aux_/config/gpu.hpp>
#include <b/mpl/aux_/config/static_constant.hpp>
#include <b/mpl/aux_/config/pp_counter.hpp>
#include <b/mpl/aux_/config/workaround.hpp>

#include <b/preprocessor/cat.hpp>

#include <b/config.hpp> // make sure 'size_t' is placed into 'std'
#include <cstddef>
