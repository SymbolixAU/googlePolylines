...
#include <b/locale/config.hpp>
#include <b/locale/detail/encoding.hpp>
#include <b/locale/encoding_errors.hpp>
#include <b/locale/encoding_utf.hpp>
#include <b/locale/info.hpp>
#include <b/locale/util/string.hpp>
#include <memory>
