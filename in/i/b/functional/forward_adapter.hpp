...
#   include#include <b/config/workaround.hpp>

#   include#include <b/preprocessor/iteration/iterate.hpp>
#   include#include <b/preprocessor/repetition/enum_params.hpp>
#   include#include <b/preprocessor/repetition/enum_binary_params.hpp>
#   include#include <b/preprocessor/facilities/intercept.hpp>
#   include#include <b/preprocessor/arithmetic/dec.hpp>

#   include#include <b/utility/result_of.hpp>
...
#       define  BOOST_PP_FILENAME_1#include <b/functional/forward_adapter.hpp>
...
#     define  BOOST_PP_FILENAME_2#include <b/functional/forward_adapter.hpp>
#     define  BOOST_PP_ITERATION_LIMITS (0,limit2)
#     include BOOST_PP_ITERATE()
#   elif BOOST_PP_ITERATION_DEPTH() == 2 && limit3
#     define  BOOST_PP_FILENAME_3#include <b/functional/forward_adapter.hpp>
