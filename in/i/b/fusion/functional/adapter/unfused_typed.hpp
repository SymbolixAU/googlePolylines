...
#include <b/fusion/functional/adapter/limits.hpp>
#include <b/fusion/functional/adapter/detail/access.hpp>
...
namespace boost { namespace fusion
{
    ...
    #define  BOOST_PP_FILENAME_1#include <b/fusion/functional/adapter/unfused_typed.hpp>
