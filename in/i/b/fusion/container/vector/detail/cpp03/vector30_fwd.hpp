...
#include <b/fusion/container/vector/detail/cpp03/preprocessed/vector30_fwd.hpp>
#else
...
namespace boost { namespace fusion
{
    ...
    #define BOOST_PP_FILENAME_1#include <b/fusion/container/vector/detail/cpp03/vector30_fwd.hpp>
