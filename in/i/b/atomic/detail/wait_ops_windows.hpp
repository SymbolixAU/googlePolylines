...
#include <b/winapi/wait_constants.hpp>
#include <b/atomic/detail/wait_operations_fwd.hpp>
#include <b/atomic/detail/wait_capabilities.hpp>
#if defined(BOOST_ATOMIC_DETAIL_WINDOWS_HAS_WAIT_ON_ADDRESS)
#include <b/winapi/wait_on_address.hpp>
...
#include <b/config/auto_link.hpp>
...
#include <cstddef>
#include <b/atomic/detail/wait_on_address.hpp>
#include <b/atomic/detail/wait_ops_generic.hpp>
