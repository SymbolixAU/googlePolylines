...
#include <b/atomic/detail/interlocked.hpp>
#include <b/atomic/detail/storage_traits.hpp>
#include <b/atomic/detail/core_arch_operations_fwd.hpp>
#include <b/atomic/detail/type_traits/make_signed.hpp>
#include <b/atomic/detail/capabilities.hpp>
#if defined(BOOST_ATOMIC_DETAIL_X86_HAS_CMPXCHG8B) || defined(BOOST_ATOMIC_DETAIL_X86_HAS_CMPXCHG16B)
#include <b/cstdint.hpp>
#include <b/atomic/detail/cas_based_exchange.hpp>
#include <b/atomic/detail/core_ops_cas_based.hpp>
#endif
#if defined(BOOST_ATOMIC_DETAIL_X86_HAS_CMPXCHG16B) && defined(__AVX__)
#include <emmintrin.h>
#include <b/atomic/detail/string_ops.hpp>
#endif
#include <b/atomic/detail/ops_msvc_common.hpp>
...
#include <b/atomic/detail/extending_cas_based_arithmetic.hpp>
#endif
