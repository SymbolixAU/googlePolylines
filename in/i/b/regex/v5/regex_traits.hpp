...
#include <b/regex/v5/syntax_type.hpp>
#include <b/regex/v5/error_type.hpp>
#include <b/regex/v5/regex_traits_defaults.hpp>
#include <b/regex/v5/cpp_regex_traits.hpp>
#include <b/regex/v5/c_regex_traits.hpp>
