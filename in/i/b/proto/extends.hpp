...
#include <b/proto/expr.hpp>
#include <b/proto/args.hpp>
#include <b/proto/traits.hpp>
#include <b/proto/generate.hpp>
#include <b/proto/detail/remove_typename.hpp>
...
namespace boost { namespace proto
{
    ...
    namespace exprns_
    {
        ...
        struct extends
        {
            ...
            #include <b/proto/detail/extends_funop_const.hpp>
        };
        ...
        struct extends<Expr, Derived, Domain, 0>
        {
            ...
            // nested preprocessor loops, use file iteration here to generate
            // the operator() overloads, which is more efficient.
            #include <b/proto/detail/extends_funop.hpp>
        };
