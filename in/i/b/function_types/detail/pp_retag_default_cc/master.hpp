...
#   include#include <b/preprocessor/slot/slot.hpp>
#   include#include <b/preprocessor/iteration/self.hpp>
...
#   define BOOST_FT_self \
     #include <b/function_types/detail/pp_retag_default_cc/master.hpp>
