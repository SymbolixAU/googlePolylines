...
#include <b/mpl/integral_c.hpp>
#include <b/mpl/vector/vector0.hpp>

#if BOOST_WORKAROUND(BOOST_BORLANDC, <= 0x565)
#   include#include <b/type_traits/remove_cv.hpp>

#   include#include <b/mpl/identity.hpp>
#   include#include <b/mpl/bitand.hpp>
#   include#include <b/mpl/vector/vector10.hpp>
#   include#include <b/mpl/front.hpp>
#   include#include <b/mpl/begin.hpp>
#   include#include <b/mpl/advance.hpp>
#   include#include <b/mpl/iterator_range.hpp>
#   include#include <b/mpl/joint_view.hpp>
#   include#include <b/mpl/equal_to.hpp>
#   include#include <b/mpl/copy.hpp>
#   include#include <b/mpl/front_inserter.hpp>

#   include#include <b/function_types/detail/classifier.hpp>
#endif

#ifndef BOOST_FT_NO_CV_FUNC_SUPPORT
#   include#include <b/mpl/remove.hpp>
#endif

#include <b/function_types/config/config.hpp>

#   if   BOOST_FT_MAX_ARITY < 10
#     include#include <b/mpl/vector/vector10.hpp>
#   elif BOOST_FT_MAX_ARITY < 20
#     include#include <b/mpl/vector/vector20.hpp>
#   elif BOOST_FT_MAX_ARITY < 30
#     include#include <b/mpl/vector/vector30.hpp>
#   elif BOOST_FT_MAX_ARITY < 40
#     include#include <b/mpl/vector/vector40.hpp>
#   elif BOOST_FT_MAX_ARITY < 50
#     include#include <b/mpl/vector/vector50.hpp>
#   endif

#include <b/function_types/detail/class_transform.hpp>
...
#include <b/function_types/detail/components_as_mpl_sequence.hpp>
#include <b/function_types/detail/retag_default_cc.hpp>
