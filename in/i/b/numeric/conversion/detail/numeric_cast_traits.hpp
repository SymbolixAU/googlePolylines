...
//
    ...
    #include <b/numeric/conversion/detail/preprocessed/numeric_cast_traits_common.hpp>
	
	#if !defined(BOOST_NO_LONG_LONG)
        #include <b/numeric/conversion/detail/preprocessed/numeric_cast_traits_long_long.hpp>
	#endif
