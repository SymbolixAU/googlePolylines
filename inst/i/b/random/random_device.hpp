...
#include <b/random/detail/auto_link.hpp>
#include <b/system/config.hpp> // force autolink to find Boost.System
 ...
 * <b>Performance</b>
 *
 * The test program <a href="\b/libs/random/performance/nondet_random_speed.cpp">
