...
//   01 April 2001: Modified to use new <b/limits.hpp> header. (JMaddock)
//
...
#include <b/graph/relax.hpp>
#include <b/pending/indirect_cmp.hpp>
#include <b/graph/exception.hpp>
#include <b/graph/overloading.hpp>
#include <b/smart_ptr.hpp>
#include <b/graph/detail/d_ary_heap.hpp>
#include <b/graph/two_bit_color_map.hpp>
#include <b/graph/detail/mpi_include.hpp>
#include <b/property_map/property_map.hpp>
#include <b/property_map/vector_property_map.hpp>
#include <b/type_traits.hpp>
#include <b/concept/assert.hpp>

#ifdef BOOST_GRAPH_DIJKSTRA_TESTING
#include <b/pending/mutable_queue.hpp>
...
namespace detail
{
    ...
    struct dijkstra_bfs_visitor
    {
        ...
        template < class Edge, class Graph > void examine_edge(Edge e, Graph& g)
        {
            ...
            //    https://svn.boost.org/trac/b/ticket/8398).
            ...
            //    https://svn.boost.org/trac/b/ticket/9012).
...
#include BOOST_GRAPH_MPI_INCLUDE(<b/graph/distributed/dijkstra_shortest_paths.hpp>)
