...
#include <b/graph/depth_first_search.hpp>
#include <b/type_traits/conversion_traits.hpp>
...
#include <queue>
#include <vector>
#include <b/graph/transpose_graph.hpp>
#include <b/pending/indirect_cmp.hpp>
#include <b/graph/connected_components.hpp> // for components_recorder
...
#include BOOST_GRAPH_MPI_INCLUDE(<b/graph/distributed/strong_components.hpp>)
