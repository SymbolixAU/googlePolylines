...
#pragma message( \
    "Warning: This header is deprecated. Please use: b/graph/edmonds_karp_max_flow.hpp")
#elif defined(__GNUC__) || defined(__HP_aCC) || defined(__SUNPRO_CC) \
    || defined(__IBMCPP__) || defined(__BORLANDC__)
#warning \
    "This header is deprecated. Please use: b/graph/edmonds_karp_max_flow.hpp"
#endif

#include <b/graph/edmonds_karp_max_flow.hpp>
