...
#include <b/pending/property.hpp> // for boost::lookup_one_property
#include <b/pending/container_traits.hpp>
#include <b/throw_exception.hpp>
#include <b/tuple/tuple.hpp> // for boost::make_tuple
...
#define BGL_NAMED_GRAPH named_graph< Graph, Vertex, VertexProperty >
        ...
        Vertex vertex, VertexIterStability)
    {
        BOOST_STATIC_ASSERT_MSG(
            ...
            "https://svn.boost.org/trac/b/ticket/7863 for more information "
            "and a test case.");
