...
#include <b/atomic/capabilities.hpp>
#include <b/atomic/detail/config.hpp>
#include <b/atomic/detail/classify.hpp>
#include <b/atomic/detail/atomic_impl.hpp>
#include <b/atomic/detail/type_traits/is_trivially_copyable.hpp>
