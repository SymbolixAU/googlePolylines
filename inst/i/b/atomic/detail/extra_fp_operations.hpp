...
#include <b/atomic/detail/extra_fp_ops_generic.hpp>
#include <b/atomic/detail/extra_fp_ops_emulated.hpp>

#if !defined(BOOST_ATOMIC_DETAIL_EXTRA_FP_BACKEND_GENERIC)
#include BOOST_ATOMIC_DETAIL_EXTRA_FP_BACKEND_HEADER(b/atomic/detail/extra_fp_ops_)
#endif
