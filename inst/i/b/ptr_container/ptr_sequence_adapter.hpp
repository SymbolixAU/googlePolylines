...
#include <b/ptr_container/detail/reversible_ptr_container.hpp>
#include <b/ptr_container/indirect_fun.hpp>
#include <b/ptr_container/detail/void_ptr_iterator.hpp>
