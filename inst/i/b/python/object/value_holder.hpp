...
#  include <b/python/object/value_holder_fwd.hpp>

#  include <b/python/instance_holder.hpp>
#  include <b/python/type_id.hpp>
#  include <b/python/wrapper.hpp>

#  include <b/python/object/inheritance_query.hpp>
...
#  include <b/utility/addressof.hpp>
...
#  define BOOST_PP_ITERATION_PARAMS_1 (4, (0, BOOST_PYTHON_MAX_ARITY, <b/python/object/value_holder.hpp>, 1))
...
struct value_holder_back_reference : instance_holder
{
    ...
    // Forward construction to the held object
#  define BOOST_PP_ITERATION_PARAMS_1 (4, (0, BOOST_PYTHON_MAX_ARITY, <b/python/object/value_holder.hpp>, 2))
#  include BOOST_PP_ITERATE()
