...
#  include <b/detail/indirect_traits.hpp>

#  include <b/python/detail/invoke.hpp>
#  include <b/python/detail/signature.hpp>
#  include <b/python/detail/preprocessor.hpp>
#  include <b/python/detail/type_traits.hpp>

#  include <b/python/arg_from_python.hpp>
#  include <b/python/converter/context_result_converter.hpp>
...
#  define BOOST_PP_ITERATION_PARAMS_1                                            \
        (3, (0, BOOST_PYTHON_MAX_ARITY + 1, <b/python/detail/caller.hpp>))
