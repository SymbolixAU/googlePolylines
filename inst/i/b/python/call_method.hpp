...
#  include <b/python/converter/return_from_python.hpp>
#  include <b/python/detail/preprocessor.hpp>
#  include <b/python/detail/void_return.hpp>
...
# define BOOST_PP_ITERATION_PARAMS_1 (3, (0, BOOST_PYTHON_MAX_ARITY, <b/python/call_method.hpp>))
