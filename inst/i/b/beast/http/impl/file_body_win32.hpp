...
#include <b/beast/core/async_base.hpp>
#include <b/beast/core/bind_handler.hpp>
#include <b/beast/core/buffers_range.hpp>
#include <b/beast/core/detail/clamp.hpp>
#include <b/beast/core/detail/is_invocable.hpp>
#include <b/beast/http/error.hpp>
#include <b/beast/http/write.hpp>
#include <b/beast/http/serializer.hpp>
#include <b/asio/async_result.hpp>
#include <b/asio/basic_stream_socket.hpp>
#include <b/asio/windows/overlapped_ptr.hpp>
#include <b/make_unique.hpp>
#include <b/smart_ptr/make_shared_array.hpp>
...
{
    // from
    // https://github.com/boostorg/asio/blob/6534af41b471288091ae39f9ab801594189b6fc9/include/b/asio/detail/impl/socket_ops.ipp#L842
    switch(dwError)
    {
