...
//Thread launching functions are adapted from b/detail/lightweight_thread.hpp
//
//  b/detail/lightweight_thread.hpp
//
...
#include <b/interprocess/streams/bufferstream.hpp>
#include <cstddef>
#include <ostream>
