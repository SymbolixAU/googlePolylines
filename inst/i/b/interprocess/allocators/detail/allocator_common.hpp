...
#include <b/interprocess/interprocess_fwd.hpp>
#include <b/interprocess/detail/utilities.hpp> //to_raw_pointer
#include <b/utility/addressof.hpp> //boost::addressof
#include <b/assert.hpp>   //BOOST_ASSERT
#include <b/interprocess/exceptions.hpp> //bad_alloc
#include <b/interprocess/sync/scoped_lock.hpp> //scoped_lock
#include <b/interprocess/containers/allocation_type.hpp> //boost::interprocess::allocation_type
#include <b/container/detail/multiallocation_chain.hpp>
