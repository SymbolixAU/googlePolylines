...
public:
    ...
    /// \note Derived class header \b must include <b/container_hash/hash.hpp>, \b unless this function is redefined in
...
/// \note <b/container_hash/hash.hpp> has to be included if this function is used.
template <class Derived, class TypeInfo>
