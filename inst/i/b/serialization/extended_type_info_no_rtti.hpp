...
#include <b/serialization/extended_type_info.hpp>
#include <b/serialization/factory.hpp>
#include <b/serialization/throw_exception.hpp>

#include <b/serialization/config.hpp>
// hijack serialization access
#include <b/serialization/access.hpp>

#include <b/config/abi_prefix.hpp> // must be the last header
#ifdef BOOST_MSVC
#  pragma warning(push)
