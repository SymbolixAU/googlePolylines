...
#include <functional>
#include <utility>
#include <b/process/detail/config.hpp>
#include <b/process/pipe.hpp>

#include <future>

#if defined(BOOST_POSIX_API)
#include <b/process/detail/posix/asio_fwd.hpp>
#include <b/process/detail/posix/close_in.hpp>
#include <b/process/detail/posix/close_out.hpp>
#include <b/process/detail/posix/null_in.hpp>
#include <b/process/detail/posix/null_out.hpp>
#include <b/process/detail/posix/file_in.hpp>
#include <b/process/detail/posix/file_out.hpp>
#include <b/process/detail/posix/pipe_in.hpp>
#include <b/process/detail/posix/pipe_out.hpp>
#elif defined(BOOST_WINDOWS_API)
#include <b/process/detail/windows/asio_fwd.hpp>
#include <b/process/detail/windows/close_in.hpp>
#include <b/process/detail/windows/close_out.hpp>
#include <b/process/detail/windows/null_in.hpp>
#include <b/process/detail/windows/null_out.hpp>
#include <b/process/detail/windows/file_in.hpp>
#include <b/process/detail/windows/file_out.hpp>
#include <b/process/detail/windows/pipe_in.hpp>
#include <b/process/detail/windows/pipe_out.hpp>
#endif

/** \file b/process/io.hpp
 *
...
\note `b/process/async.hpp` must also be included for this to work.
...
\warning This feature requires `b/process/async.hpp` to be included and a reference to `boost::asio::io_context` to be passed to the launching function.
