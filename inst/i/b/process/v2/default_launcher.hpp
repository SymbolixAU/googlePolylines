//
// b/process/v2/default_launcher.hpp
// ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
//
...
#include <b/process/v2/windows/default_launcher.hpp>
#else
#if defined(BOOST_PROCESS_V2_PDFORK)
#include <b/process/v2/posix/pdfork_launcher.hpp>
#else
#include <b/process/v2/posix/default_launcher.hpp>
#endif
