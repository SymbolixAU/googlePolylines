...
#include <b/process/locale.hpp>
#include <b/process/detail/traits/wchar_t.hpp>

#if defined (BOOST_POSIX_API)
#include <b/process/detail/posix/start_dir.hpp>
#elif defined (BOOST_WINDOWS_API)
#include <b/process/detail/windows/start_dir.hpp>
#endif

#include <b/process/detail/config.hpp>
#include <string>
#include <b/process/filesystem.hpp>

/** \file b/process/start_dir.hpp
 *
