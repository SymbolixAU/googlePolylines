...
#include <b/phoenix/core/domain.hpp>
#include <b/phoenix/core/meta_grammar.hpp>
#include <b/phoenix/core/call.hpp>
#include <b/phoenix/core/expression.hpp>
...
#include <b/phoenix/support/iterate.hpp>

#ifdef BOOST_PHOENIX_NO_VARIADIC_EXPRESSION
#   include <b/phoenix/operator/detail/cpp03/mem_fun_ptr_expr.hpp>
#else
...
#include <b/phoenix/operator/detail/define_operator.hpp>

namespace boost { namespace phoenix
{
#if defined(BOOST_PHOENIX_NO_VARIADIC_OPERATOR)
    #include <b/phoenix/operator/detail/cpp03/mem_fun_ptr_gen.hpp>
#else
    // TODO
#endif
...
#if defined(BOOST_PHOENIX_NO_VARIADIC_OPERATOR)
        #include <b/phoenix/operator/detail/cpp03/mem_fun_ptr_eval_result_of.hpp>
#else
    // TODO
#endif
    }
...
#if defined(BOOST_PHOENIX_NO_VARIADIC_OPERATOR)
        #include <b/phoenix/operator/detail/cpp03/mem_fun_ptr_eval.hpp>
#else
    // TODO
#endif
    };
...
#include <b/phoenix/operator/detail/undef_operator.hpp>
