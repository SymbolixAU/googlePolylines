...
#include <b/mp11/tuple.hpp>
#include <b/throw_exception.hpp>
#include <b/unordered/detail/archive_constructed.hpp>
#include <b/unordered/detail/bad_archive_exception.hpp>
#include <b/unordered/detail/foa/core.hpp>
#include <b/unordered/detail/foa/reentrancy_check.hpp>
#include <b/unordered/detail/foa/rw_spinlock.hpp>
#include <b/unordered/detail/foa/tuple_rotate_right.hpp>
#include <b/unordered/detail/serialization_version.hpp>
#include <b/unordered/detail/static_assert.hpp>
#include <cstddef>
#include <functional>
...
/* inspired by b/multi_index/detail/scoped_bilock.hpp */
...
#include <b/unordered/detail/foa/ignore_wshadow.hpp>
...
#pragma warning(pop) /* C4800 */
  ...
  void save(Archive& ar,unsigned int,std::false_type /* map */)const
  {
    ...
    super::for_all_elements([&,this](element_type* p){
       ...
       * (b/serialization/utility.hpp), we serialize the key and the
...
#include <b/unordered/detail/foa/restore_wshadow.hpp>
