...
#include <b/accumulators/statistics/max.hpp>
#include <b/accumulators/statistics/min.hpp>
#include <b/accumulators/statistics/density.hpp> // for named parameters density_cache_size and density_num_bins
