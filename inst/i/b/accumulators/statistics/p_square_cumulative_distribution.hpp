...
#  pragma message ("Warning: This header is deprecated. Please use: b/accumulators/statistics/p_square_cumul_dist.hpp")
#elif defined(__GNUC__) || defined(__HP_aCC) || defined(__SUNPRO_CC) || defined(__IBMCPP__) || defined(__BORLANDC__)
#  warning "This header is deprecated. Please use: b/accumulators/statistics/p_square_cumul_dist.hpp"
#endif

#include <b/accumulators/statistics/p_square_cumul_dist.hpp>
