...
//   01 Apr 01  Modified to use new <b/limits.hpp> header. (John Maddock)
...
#include <b/integer_fwd.hpp>  // self include

#include <b/integer_traits.hpp>  // for boost::::boost::integer_traits
#include <b/limits.hpp>          // for ::std::numeric_limits
#include <b/cstdint.hpp>         // for boost::int64_t and BOOST_NO_INTEGRAL_INT64_T
