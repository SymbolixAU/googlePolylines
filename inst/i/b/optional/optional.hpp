...
#include <b/optional/detail/optional_utility.hpp>
...
{
  static_assert(sizeof(CharType) == 0, "If you want to output boost::optional, include header <b/optional/optional_io.hpp>");
  return os;
}
