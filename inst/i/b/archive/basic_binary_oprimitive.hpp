...
#include <b/scoped_ptr.hpp>
#include <b/serialization/throw_exception.hpp>

#include <b/serialization/is_bitwise_serializable.hpp>
#include <b/serialization/array_wrapper.hpp>

#include <b/archive/basic_streambuf_locale_saver.hpp>
#include <b/archive/codecvt_null.hpp>
#include <b/archive/archive_exception.hpp>
#include <b/archive/detail/auto_link_archive.hpp>
#include <b/archive/detail/abi_prefix.hpp> // must be the last header
...
#include <b/archive/detail/abi_suffix.hpp> // pop pragmas
