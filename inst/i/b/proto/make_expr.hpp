...
#include <b/proto/generate.hpp>
#include <b/fusion/include/at_c.hpp>
#include <b/fusion/include/begin.hpp>
#include <b/fusion/include/next.hpp>
#include <b/fusion/include/value_of.hpp>
#include <b/fusion/include/size.hpp>
#include <b/proto/detail/poly_function.hpp>
#include <b/proto/detail/deprecated.hpp>
...
#define BOOST_PROTO_AS_CHILD(Z, N, DATA)                                                        \
    ...
    namespace detail
    {
        ...
        #include <b/proto/detail/unpack_expr_.hpp>

        // Definition of detail::make_expr_
        #include <b/proto/detail/make_expr_.hpp>
    }
    ...
    namespace functional
    {
        ...
        struct make_expr
        {
            ...
            #include <b/proto/detail/make_expr_funop.hpp>
    ...
    // Additional overloads generated by the preprocessor...
    #include <b/proto/detail/make_expr.hpp>
