...
#include <b/json/error.hpp>
#include <b/json/kind.hpp>
#include <b/json/parse_options.hpp>
#include <b/json/detail/stack.hpp>
#include <b/json/detail/stream.hpp>
#include <b/json/detail/utf8.hpp>
#include <b/json/detail/sbo_buffer.hpp>
...
\n
    ...
    file instead:
    @code
    #include <b/json/basic_parser_impl.hpp>
    @endcode
...
\n
    ...
    @headerfile <b/json/basic_parser.hpp>
*/
