...
#include <b/parameter/aux_/pack/make_arg_list.hpp>
#include <b/parameter/aux_/pack/make_parameter_spec_items.hpp>
#include <b/parameter/aux_/pack/tag_keyword_arg.hpp>
#include <b/parameter/aux_/pack/tag_template_keyword_arg.hpp>
...
#if defined(BOOST_PARAMETER_CAN_USE_MP11)
//#include <b/mp11/mpl.hpp>
#define BOOST_PARAMETER_VARIADIC_MPL_SEQUENCE ::boost::mp11::mp_list
#else
#include <b/fusion/container/list/list_fwd.hpp>
...
#include <b/fusion/container/list.hpp>
#include <b/fusion/mpl.hpp>
#define BOOST_PARAMETER_VARIADIC_MPL_SEQUENCE ::boost::fusion::list
#else
#include <b/fusion/container/deque/deque_fwd.hpp>

#if defined(BOOST_FUSION_HAS_VARIADIC_DEQUE)
#include <b/fusion/container/deque.hpp>
#include <b/fusion/mpl.hpp>
...
#include <b/parameter/aux_/arg_list.hpp>
#include <b/parameter/aux_/pack/make_arg_list.hpp>
#include <b/parameter/aux_/pack/make_items.hpp>
#include <b/parameter/aux_/pack/make_deduced_items.hpp>
#include <b/parameter/aux_/pack/tag_template_keyword_arg.hpp>
#include <b/parameter/aux_/preprocessor/binary_seq_for_each.hpp>
...
#include <b/preprocessor/selection/min.hpp>

#if ( \
        BOOST_PARAMETER_EXPONENTIAL_OVERLOAD_THRESHOLD_ARITY < \
        BOOST_PARAMETER_MAX_ARITY \
    )
#include <b/parameter/aux_/pack/tag_keyword_arg_ref.hpp>
#include <b/mpl/pair.hpp>
...
#include <b/parameter/aux_/preprocessor/no_perfect_forwarding_begin.hpp>
...
#define BOOST_PP_ITERATION_PARAMS_1 \
    (3,( \
        BOOST_PARAMETER_EXPONENTIAL_OVERLOAD_THRESHOLD_ARITY \
      , BOOST_PARAMETER_MAX_ARITY \
      , <b/parameter/aux_/preprocessor/overloads.hpp> \
    ))
...
#include <b/parameter/aux_/preprocessor/no_perfect_forwarding_end.hpp>
