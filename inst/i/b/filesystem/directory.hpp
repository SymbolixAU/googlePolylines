...
#include <b/filesystem/config.hpp>
#include <b/filesystem/path.hpp>
#include <b/filesystem/file_status.hpp>
#include <b/filesystem/detail/path_traits.hpp>
...
#include <b/core/scoped_enum.hpp>
#include <b/detail/bitmask.hpp>
#include <b/system/error_code.hpp>
#include <b/smart_ptr/intrusive_ptr.hpp>
#include <b/smart_ptr/intrusive_ref_counter.hpp>
#include <b/iterator/iterator_facade.hpp>
#include <b/iterator/iterator_categories.hpp>

#include <b/filesystem/detail/header.hpp> // must be the last #include
...
#include <b/filesystem/detail/footer.hpp>
