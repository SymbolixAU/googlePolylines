...
rcpp_polyline_centroid <- function(wkt) {
    .Call('_googlePolylines_rcpp_polyline_centroid', PACKAGE = 'googlePolylines', wkt)
}

rcpp_polyline_algorithm <- function(wkt, algorithm) {
    .Call('_googlePolylines_rcpp_polyline_algorithm', PACKAGE = 'googlePolylines', wkt, algorithm)
}
